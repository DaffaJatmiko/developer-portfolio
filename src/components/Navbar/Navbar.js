  ...
  return (
    <div className="navbar">
      <div className="navbar--container">
        <h1 style={{ color: theme.secondary }}>Kelompok 29</h1>
            ...
            <Fade left>
              <NavLink to="/#about" smooth={true} spy="true" duration={2000}>
                <div className={classes.drawerItem}>
                  ...
                  <span className={classes.drawerLinks}>Tentang Kami</span>
                </div>
              </NavLink>
            </Fade>
            ...
            <Fade left>
              <NavLink to="/#projects" smooth={true} spy="true" duration={2000}>
                <div className={classes.drawerItem}>
                  ...
                  <span className={classes.drawerLinks}>Program Kerja</span>
                </div>
              </NavLink>
            </Fade>
            ...
            {/* <Fade left>
                <NavLink to="/#skill" smooth={true} spy="true" duration={2000}>
                  <div className={classes.drawerItem}>
                    ...
                    <span className={classes.drawerLinks}>Anggota</span>
                  </div>
                </NavLink>
              </Fade> */}
